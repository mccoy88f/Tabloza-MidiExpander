const I18N = {
  it: {
    ...
    sf2LoadingLarge: "Caricamento {name}… (fino a 3 min)",
    ...
    jackTestDone: "Segnale inviato — dovresti sentire un La (440 Hz) ~3 s sul jack",
  ...
  en: {
    ...
    sf2LoadingLarge: "Loading {name}… (up to 3 min)",
    ...
    jackTestDone: "Tone sent — you should hear A440 ~3s on the jack",
