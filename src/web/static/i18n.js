const I18N = {
  it: {
    ...
    jackTestWorking: "Segnale sul jack cuffie…",
    audioTestDone: "Nota inviata — dovresti sentire un Do",
    jackTestDone: "Segnale stereo inviato — dovresti sentire un La (440 Hz) su entrambe le cuffie",
    ...
    sectionVolume: "Volume uscita audio (jack)",
  ...
  en: {
    ...
    jackTestWorking: "Playing tone on headphone jack…",
    audioTestDone: "Note sent — you should hear middle C",
    jackTestDone: "Stereo tone sent — you should hear A440 in both ears",
    ...
    sectionVolume: "Audio output volume (jack)",
